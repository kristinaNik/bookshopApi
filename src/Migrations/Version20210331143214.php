 ...
 */
final class Version20210331143214 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE order_order_line (order_id INT NOT NULL, order_line_id INT NOT NULL, INDEX IDX_2F3F73B48D9F6D38 (order_id), INDEX IDX_2F3F73B4BB01DC09 (order_line_id), PRIMARY KEY(order_id, order_line_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
